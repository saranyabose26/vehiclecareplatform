		...
		<div className="lg:w-[260px] sm:w-[300px] overflow-hidden relative bg-primary rounded-lg shadow-3xl">
			<section className="relative">
				<Link to={`/product/${p._id}`}>
					<span className="absolute bottom-3 right-3 bg-emerald-50 text-coral-red text-sm font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-pink-900 dark:text-coral-red">
						{p?.brand}
					</span>
					<img
			...
			<div className="p-5">
				<div className="flex justify-between">
					<h5 className="mb-2 text-xl dark:text-slate-gray">{p?.name}</h5>

					<p className="font-semibold text-coral-red">
				...
				<p className="mb-3 font-normal text-sm text-[#6a6969]">
